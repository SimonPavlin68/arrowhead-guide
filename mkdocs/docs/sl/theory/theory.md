...
v_{0x} = v_0 \cos \alpha
$$
in na komponento v navpični smeri:
$$
v_{0y} = v_0 \sin \alpha
$$
V času **_t_** ima telo koordinati:
...
Hitrost telesa se pri dvigovanju počasi zmanjšuje in je po času (čas dvigovanja) enaka nič:

$$
t_d = \frac{v_{0y}}{g} = \frac{v_0 \sin \alpha}{g}
$$

Tedaj telo doseže največjo višino:
