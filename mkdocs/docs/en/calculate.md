...
Below you can enter the initial speed, distance and angle, and calculate how to set the sight.
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    console.log("sendCalc")
        ...
        try {
            ...
            merekEl.value = data.merek ?? "Error";
        } catch (err) {
            merekEl.value = "Sending error";
            console.error(err);
        }
    }
